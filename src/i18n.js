...
export const DICT = {
  es: {
    ...
    'dash.nodata':'Aún no hay historial. El patrimonio se registra automáticamente cada día que abras la app.','chart.flat':'Sin cambios en este periodo — el mercado estuvo cerrado o los precios no se movieron.','chart.closed':'Mercado cerrado. Tus precios se mueven otra vez el','chart.few':'{n} mediciones registradas. La curva se va formando cada día que abras la app.',
    ...
    'set.avkey':'API key de Alpha Vantage (opcional)','set.avHelp':'Sirve para los dividendos automáticos y el historial de precios. Consíguela gratis en alphavantage.co/support/#api-key','set.avTest':'Probar la key de dividendos','set.avTesting':'Probando…','set.avOk':'Funciona: {n} dividendos encontrados para IVV','set.avFail':'El proveedor respondió: {m}','set.avLast':'Última respuesta del proveedor',
    ...
    'set.data':'Datos','set.rebuild':'Reconstruir historial desde mis movimientos','set.rebuildHelp':'Antes, todo lo que hacías en un día se guardaba como un solo valor y la gráfica perdía los escalones. Esto reconstruye la curva a partir de tu historial: el efectivo es exacto y cada posición se valúa al precio al que la compraste. Es una reconstrucción, no datos observados.','set.rebuilt':'Historial reconstruido: {n} puntos','set.export':'Exportar respaldo (.json)','set.import':'Importar respaldo',
    ...
    'dv.check':'Buscar dividendos','dv.checking':'Buscando…','dv.noneShort':'Sin dividendos nuevos','dv.recordedFound':'{n} dividendos encontrados','dv.limitShort':'El proveedor está limitando ahora','dv.found':'{n} dividendo por registrar','dv.foundN':'{n} dividendos por registrar','dv.none':'No hay dividendos nuevos por registrar.','dv.recordAll':'Registrar todos','dv.upcoming':'Próximo pago','dv.perShare':'por título','dv.paidOn':'Pagado el','dv.willPay':'Paga el','dv.needKey':'Para detectarlos solos necesitas una API key gratuita de Alpha Vantage (Ajustes → Datos de mercado). Toma 20 segundos y es gratis.','dv.limit':'Alpha Vantage está limitando las consultas en este momento. Limita por dirección IP además de por API key, y a veces lo hace aunque no hayas gastado tu cuota. La app ya reintentó y volverá a intentar sola en 20 minutos. Puedes verificar tu key en Ajustes → Datos de mercado, o registrar los dividendos a mano.','dv.demo':'Estás usando la key de ejemplo ("demo"), que solo funciona con IBM. Consigue una gratuita en alphavantage.co/support/#api-key y ponla en Ajustes → Datos de mercado.','dv.badkey':'Falta la API key de Alpha Vantage o está mal escrita. Revísala en Ajustes → Datos de mercado.','dv.other':'El proveedor de dividendos no respondió con datos. Intenta más tarde o registra el dividendo a mano.','dv.auto':'Registrar dividendos automáticamente','dv.autoHelp':'Al abrir la app, los dividendos que te tocaron se abonan solos a tu efectivo, con la fecha en que se pagaron. Necesita la API key de Alpha Vantage.','dv.autoDone':'Se registraron {n} dividendos automáticamente','dv.recorded':'{n} dividendos registrados',
  ...
  en: {
    ...
    'dash.nodata':'No history yet. Net worth is recorded automatically each day you open the app.','chart.flat':'No change over this period — the market was closed or prices did not move.','chart.closed':'Market closed. Your prices start moving again on','chart.few':'{n} readings recorded. The curve fills in each day you open the app.',
    ...
    'set.avkey':'Alpha Vantage API key (optional)','set.avHelp':'Used for automatic dividends and price history. Get one free at alphavantage.co/support/#api-key','set.avTest':'Test the dividend key','set.avTesting':'Testing…','set.avOk':'Works: {n} dividends found for IVV','set.avFail':'The provider replied: {m}','set.avLast':'Last provider reply',
    ...
    'set.data':'Data','set.rebuild':'Rebuild history from my movements','set.rebuildHelp':'Until now a whole day of activity was stored as a single value and the chart lost the steps. This rebuilds the curve from your ledger: cash is exact and each holding is valued at the price you bought it. It is a reconstruction, not observed data.','set.rebuilt':'History rebuilt: {n} points','set.export':'Export backup (.json)','set.import':'Import backup',
    ...
    'dv.check':'Check for dividends','dv.checking':'Checking…','dv.noneShort':'No new dividends','dv.recordedFound':'{n} dividends found','dv.limitShort':'Provider is throttling right now','dv.found':'{n} dividend to record','dv.foundN':'{n} dividends to record','dv.none':'No new dividends to record.','dv.recordAll':'Record all','dv.upcoming':'Next payment','dv.perShare':'per share','dv.paidOn':'Paid on','dv.willPay':'Pays on','dv.needKey':'Detecting them automatically needs a free Alpha Vantage API key (Settings → Market data). It takes 20 seconds and costs nothing.','dv.limit':'Alpha Vantage is throttling requests right now. It limits by IP address as well as by API key, and sometimes does so even when your own quota is untouched. The app already retried and will try again on its own in 20 minutes. You can verify your key in Settings → Market data, or record dividends by hand.','dv.demo':'You are using the sample key ("demo"), which only works for IBM. Get a free one at alphavantage.co/support/#api-key and put it in Settings → Market data.','dv.badkey':'The Alpha Vantage API key is missing or mistyped. Check it in Settings → Market data.','dv.other':'The dividend provider did not return data. Try later, or record the dividend by hand.','dv.auto':'Record dividends automatically','dv.autoHelp':'On startup, dividends you were entitled to are credited to your cash on the date they were paid. Needs the Alpha Vantage API key.','dv.autoDone':'{n} dividends recorded automatically','dv.recorded':'{n} dividends recorded',
