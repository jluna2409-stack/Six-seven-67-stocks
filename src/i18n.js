...
export const DICT = {
  es: {
    ...
    'dv.check':'Buscar dividendos','dv.checking':'Buscando…','dv.noneShort':'Sin dividendos nuevos','dv.recordedFound':'{n} dividendos encontrados','dv.limitShort':'Consultas agotadas por hoy','dv.found':'{n} dividendo por registrar','dv.foundN':'{n} dividendos por registrar','dv.none':'No hay dividendos nuevos por registrar.','dv.recordAll':'Registrar todos','dv.upcoming':'Próximo pago','dv.perShare':'por título','dv.paidOn':'Pagado el','dv.willPay':'Paga el','dv.needKey':'Para detectarlos solos necesitas una API key gratuita de Alpha Vantage (Ajustes → Datos de mercado). Toma 20 segundos y es gratis.','dv.limit':'Alpha Vantage agotó sus 25 consultas del día. Se reinicia a medianoche (hora del Este de EE. UU.); la app reintenta sola en un par de horas. Mientras tanto puedes registrar los dividendos a mano.','dv.demo':'Estás usando la key de ejemplo ("demo"), que solo funciona con IBM. Consigue una gratuita en alphavantage.co/support/#api-key y ponla en Ajustes → Datos de mercado.','dv.badkey':'Falta la API key de Alpha Vantage o está mal escrita. Revísala en Ajustes → Datos de mercado.','dv.other':'El proveedor de dividendos no respondió con datos. Intenta más tarde o registra el dividendo a mano.','dv.auto':'Registrar dividendos automáticamente','dv.autoHelp':'Al abrir la app, los dividendos que te tocaron se abonan solos a tu efectivo, con la fecha en que se pagaron. Necesita la API key de Alpha Vantage.','dv.autoDone':'Se registraron {n} dividendos automáticamente','dv.recorded':'{n} dividendos registrados',
  ...
  en: {
    ...
    'dv.check':'Check for dividends','dv.checking':'Checking…','dv.noneShort':'No new dividends','dv.recordedFound':'{n} dividends found','dv.limitShort':'Requests used up for today','dv.found':'{n} dividend to record','dv.foundN':'{n} dividends to record','dv.none':'No new dividends to record.','dv.recordAll':'Record all','dv.upcoming':'Next payment','dv.perShare':'per share','dv.paidOn':'Paid on','dv.willPay':'Pays on','dv.needKey':'Detecting them automatically needs a free Alpha Vantage API key (Settings → Market data). It takes 20 seconds and costs nothing.','dv.limit':'Alpha Vantage has used up its 25 requests for the day. It resets at midnight US Eastern; the app retries on its own in a couple of hours. Meanwhile you can record dividends by hand.','dv.demo':'You are using the sample key ("demo"), which only works for IBM. Get a free one at alphavantage.co/support/#api-key and put it in Settings → Market data.','dv.badkey':'The Alpha Vantage API key is missing or mistyped. Check it in Settings → Market data.','dv.other':'The dividend provider did not return data. Try later, or record the dividend by hand.','dv.auto':'Record dividends automatically','dv.autoHelp':'On startup, dividends you were entitled to are credited to your cash on the date they were paid. Needs the Alpha Vantage API key.','dv.autoDone':'{n} dividends recorded automatically','dv.recorded':'{n} dividends recorded',
