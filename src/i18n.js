...
export const DICT = {
  es: {
    ...
    'tax.dueDate':'Se paga en abril de {y}','tax.unrealizedNote':'La plusvalía no realizada no paga impuesto hasta que vendes.',
  ...
  en: {
    ...
    'tax.dueDate':'Payable in April {y}','tax.unrealizedNote':'Unrealized gains are not taxed until you sell.',
