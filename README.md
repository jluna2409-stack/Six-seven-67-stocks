...
Las tarifas cargadas por omisión son las de **2025** y son **editables** desde
...
| `/stock/dividend` | ❌ **403 — de pago** | Los dividendos se **capturan a mano** desde el detalle de la posición; la app aplica la retención de EE. UU. y los suma a la declaración anual. |
...
- Dividendos automáticos por calendario del emisor (endpoint de pago).
