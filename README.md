...
| **Cobertura** | Mercados de **EE. UU.** El feed de la BMV es de pago en Finnhub (401), pero las grandes empresas mexicanas cotizan en Nueva York como ADR y **sí están**: AMX, FMX, KOF, CX, TV, ASR, PAC, OMAB, VLRS, más el ETF **EWW** (índice MSCI México). Se encuentran buscando `mexico`, `mexicanas`, `oxxo`, `cemex` o `aeropuertos`. Las que solo cotizan en la BMV (Walmex, Grupo México, Banco Bajío) no están. |
| **Calendario del mercado** | Sesión de EE. UU. de lunes a viernes 9:30–16:00 ET, **descontando los 10 feriados bursátiles** (incluido el Viernes Santo, calculado con el algoritmo de Pascua). Sin esto la app anunciaba "En vivo" en días como Labor Day, cuando no llega ni una operación. |
